...
All this architecture has been implemented with Python and Keras. Figure \ref{fig:model_keras} shows the model build, and in the following section we describe the complete pipeline with more detail.
...
\textcolor{red}{ARCHITECTURE SCHEMA}
