...
\textcolor{red}{Here I would also switch the order. First the plots together with the information that some of the data was excluded, and then mention the tables in the appendix.}
